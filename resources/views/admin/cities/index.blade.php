<x-app-layout>
    <h4 class="heading_a uk-margin-bottom">@lang('locale.city', ['suffix'=>app()->getLocale() == 'en' ? 'ies' : 's', 'prefix'=>''])</h4>
        ...
        <div class="md-card-content">
            <table id="dt_individual_search" class="uk-table" cellspacing="0" width="100%">
                <thead>
                    ...
                    <th>@lang('locale.city', ['suffix'=>app()->getLocale() == 'en' ? 'y' : '', 'prefix'=>''])</th>
                    ...
                    <tr>
                        ...
                        <td>
                            <div style="display: inline-block">
                                <a class="" data-target="#edit-city{{ $item->id }}" data-toggle="modal"><i class="typcn icon typcn-edit"></i></a>
                                {{-- <x-edit-city :city="$item" :departments="$departments"></x-edit-city> --}}
                                <a class="" href="{{ route('cities.show', $item->id) }}"><i class="typcn icon typcn-eye"></i></a>
                            </div>
                            <form action="{{ route('cities.destroy', $item->id) }}" style="display: inline-block" method="post">
                                @csrf @method('DELETE')
